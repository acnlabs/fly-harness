...
| `examples/body_loop.py` | FlyGym-shaped obs through the same port to a listed id. FlyGym / CPG are not the harness kernel; `FlyHarness.step` is brain-level above the motor CPG |
